  ...
  return <><Header/><main>
    <section className="hero">
      ...
      <div className="hero-overlay"/><div className="hero-copy">
        ...
        <div className="hero-actions"><a className="btn gold" href="/chile/passeios">Explorar passeios</a><a className="btn glass" href="https://wa.me/56900000000">Montar meu roteiro</a></div>
    ...
    <section className="featured section"><div className="section-title"><div><p className="kicker">EXPERIÊNCIAS EM DESTAQUE</p><h2>Escolhas que revelam o Chile</h2></div><a className="text-link" href="/chile/passeios">Ver todos os passeios →</a></div><div className="tour-grid">{tours.slice(0,6).map(t=><TourCard key={t.slug} tour={t}/>)}</div></section>
